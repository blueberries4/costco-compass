...
import { fmt, memberYear } from "../helpers";
  ...
  return (
    <div className={isEarned ? "glow" : ""} style={{
      ...
      <div style={{position:"relative"}}>
        ...
        <div style={{fontSize:9, opacity:0.65, marginBottom:12}}>
          {isEarned
            ? `🎉 Paid off${paidOffDate ? ` · ${paidOffDate}` : ""}! You're ${fmt(totalSaved-fee)} ahead.`
        ...
        {MEMBER.type === "Executive" && (
          <div style={{borderTop:"1px solid rgba(255,255,255,0.13)", paddingTop:10,
            ...
            <div style={{textAlign:"right"}}>
              ...
              <div style={{fontSize:11, fontWeight:600}}>{checkDate}</div>
